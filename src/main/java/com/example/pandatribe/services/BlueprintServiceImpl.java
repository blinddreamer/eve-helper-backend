...
//        });
    ...
    public BlueprintResult getBlueprintData(BlueprintRequest blueprintRequest) {
        ...
        if (Objects.nonNull(blueprintActivity)) {
            ...
            List<MaterialInfo> materialsList = materialsService.getMaterialsByActivity(matBlueprintId, craftCount, rigDiscount, blueprintMaterialEfficiency, buildingDiscount, systemInfo.getSecurity(), runs, regionId, tier);
