...
import com.example.pandatribe.exceptions.InvalidRequestException;
...
public class EveBlueprintController {
    ...
    @PostMapping("type")
    public ResponseEntity<BlueprintData> getEveType(@RequestBody BlueprintRequest blueprintRequest){
    ...
    public ResponseEntity<BlueprintData> updateSubMaterials(@RequestBody BlueprintRequest subMaterialsRequest){
    ...
    public ResponseEntity<BlueprintData> massUpdateSubMaterials(@RequestBody List<BlueprintRequest> subMaterialsRequest){
        LOGGER.info("REQUEST for submaterials: ");
        if(subMaterialsRequest == null || subMaterialsRequest.isEmpty()){
            throw new InvalidRequestException("Request list cannot be null or empty");
        }
        jsonLogger.println(subMaterialsRequest);
